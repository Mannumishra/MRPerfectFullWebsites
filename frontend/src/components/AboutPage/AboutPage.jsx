    ...
    <section className='aboutPage-section'>
      <div className="about-container">
        <div className="up">
          ...
          <div className="right">
            <span>About Us</span>
            <p>Welcome to <span>MR AND MRS PERFECT TRIPs</span> - Your ultimate gateway to unforgettable adventures and seamless travel experiences! Over the last 14 years, our team of dedicated and professional staff has provided cost-efficient tours through our network of services in India to suit the individual traveler requirements.</p>
            <p>At <span>MR AND MRS PERFECT TRIPs</span>, we believe in the transformative power of travel. Whether you're seeking an adrenaline-fueled adventure, a relaxing beach getaway, amazing time with your partner or cultural immersion in far-flung destinations, we've got you covered.</p>
        ...
        <div className="down">
          ...
          <p>Join us as we explore the world's wonders, embrace new cultures, and create lifelong memories together. At <span>MR AND MRS PERFECT TRIPs</span> the journey begins with you. Let us be your guide to extraordinary destinations and unforgettable experiences.</p>
        </div>
